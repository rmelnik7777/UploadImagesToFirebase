...
open class SHViewController: UIViewController {
    ...
    override open func viewDidLoad() {
        ...
        collectionView?.register(UINib(nibName: "SHCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: "SHCollectionViewCell")
    }
...
extension  SHViewController: UICollectionViewDataSource, UICollectionViewDelegate
{
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell : SHCollectionViewCell = collectionView.dequeueReusableCell(withReuseIdentifier: "SHCollectionViewCell", for: indexPath) as! SHCollectionViewCell
